<template>
    <transition name="md:fade">
        <div :key="open ? 'visible' : 'invisible'" :class="open ? ['h-screen'] : ['md:h-screen']" class="flex flex-col items-stretch fixed w-full md:w-64 nav-primary z-40">
            ...
            <section :class="open ? ['flex'] : ['hidden']" class="md:flex flex-col flex-grow">
